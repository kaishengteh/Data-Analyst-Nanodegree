...
# Borrower Rate and  Prosper's Rating (Alpha)
ggplot(data = subset(prosper, !is.na(ProsperRating..Alpha.)), 
       aes(x = StatedMonthlyIncome, y = LoanOriginalAmount, 
           color = ProsperRating..Alpha., size = BorrowerRate))+
...
That being said, lots of borrowers with moderate rating are also allowed to take out loans of more than $25,000 which come with moderate interest rate (0.2) to compensate for the increased risk.
